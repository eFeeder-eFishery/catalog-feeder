...
export default function WhyFeeder() {
  ...
  return (
    ...
    <div ref={whyRef}>
      ...
      <div className='absolute z-20 flex justify-center items-center w-full h-screen min-[470px]:space-x-2 lg:space-x-10 overflow-hidden'>
        <div className='flex flex-col justify-center min-[470px]:justify-start items-center min-[470px]:items-start'>
          <div className='space-y-3 pb-2 flex min-[470px]:block flex-col justify-center items-center '>
          ...
          <div className='relative pb-8 pt-4 space-y-2 whyList overflow-hidden h-[250px] w-[300px] min-[470px]:w-[200px] sm:w-[270px] md:w-[350px] lg:w-[430px] xl:w-[460px]'>
            <div className='why why1 absolute space-y-4 min-[470px]:text-left'>
            ...
            <div className='why why2 absolute space-y-4 min-[470px]:text-left opacity-1'>
            ...
            <div className='why why3 absolute z-30 space-y-4 min-[470px]:text-left opacity-1'>
        ...
        <img className='hidden min-[470px]:block min-[470px]:h-[200px] sm:h-[230px] md:h-[300px] lg:h-[380px] xl:h-[500px] xl:mt-8' src={eFeeder4} alt='eFishery'></img>
      </div>
    </div>
