    ...
    return (
        <div ref={homepageRef}>
            <div className='min-[1200px]:h-screen'>
                <div id='section-1' className='min-[1200px]:absolute h-[200px] min-[470px]:h-[300px] md:h-[350px] lg:h-[400px] min-[1200px]:h-full top-0 left-0 right-0 bottom-0 opacity-1'>
                ...
                <div id='section-2' className='relative min-[1200px]:absolute md:h-[350px] lg:h-[450px] min-[1200px]:h-full top-0 left-0 right-0 bottom-0 min-[1200px]:opacity-0'>
                    <div className='relative w-full overflow-hidden'>
                        <div className='absolute z-10 h-[100%] md:h-[350px] lg:h-[450px] min-[1200px]:h-full w-full bg-efi_darkGreen opacity-90'></div>
                        <video preload="false" autoplay="autoplay" muted loop id='video' className='w-full scale-10 opacity-1'>
                    ...
                    {/* w-[300px] min-[470px]:w-[460px] sm:w-[600px] md:w-[700px] lg:w-[1000px] xl:w-[1120px] */}
                        <div className='flex justify-center items-center h-full m-auto sm:space-x-8 md:space-x-16 min-[1200px]:space-x-24'>
                            <div className='flex flex-col justify-center sm:justify-start items-center sm:items-start space-y-0.5 sm:space-y-1 md:space-y-2 lg:space-y-3 min-[1200px]:space-y-4'>
                                <h2 className='text-sm min-[470px]:text-base sm:text-lg lg:text-2xl min-[1200px]:text-3xl font-semibold text-white'>Optimalkan Budidaya dengan</h2>
                                <h1 className='min-[470px]:text-2xl sm:text-4xl lg:text-5xl min-[1200px]:text-7xl font-extrabold text-efi_gold'>eFeeder 5</h1>
                                <p className='text-[9px] min-[470px]:text-[11px] sm:text-[13px] lg:text-base min-[1200px]:text-lg font-light text-white sm:text-left pb-2 min-[1200px]:pb-0'>Alat pemberi pakan pintar <br></br>untuk ikan dan udang</p>
                                <p className='py-1 sm:py-1.5 lg:py-2 px-8 lg:px-12 text-[11px] sm:text-sm lg:text-base min-[1200px]:text-lg font-semibold bg-efi_gold text-black rounded-full cursor-pointer hover:bg-efi_lightGold'>Order Sekarang</p>
                            </div>
